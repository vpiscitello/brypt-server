...
var NodeContainer = {
    ...
    props: {
        title: String, // The title of the node group
        nodes: Array, // The array of nodes in the group
        needSpinner: Boolean // Defines whether or not the group needs an async loading spinner
    },
    data: function() {
        return {
            ui: {
